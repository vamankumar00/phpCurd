...
<form style="padding-top: 3%; padding-left: 10%;" class="form-group col-6" action="create.php" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" class="form-control" id="inventoryId" name="inventoryId" required value="<?php echo $row["id"]; ?>">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control-file" id="inventoryImage" name="inventoryImage" required>
        </div>
